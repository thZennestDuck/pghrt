...
\section{MYTHES ET AUTRES}\label{MM}


\subsection*{Questions Fréquentes}
\addcontentsline{toc}{subsection}{\textemdash{} Questions Fréquentes}

\subsection{Est-ce que je devrais m'inquièter des caillots sanguins ?}\label{11-1}
...
Oui et non. Il est vrai qu'il y a une correlation entre le dosage d'oestrogènes / tes niveaux et le risque de caillots sanguins, mais c'est principalement lié à la voie d'administration et au type d'oestrogènes. Les oestrogènes synthétiques sont 
