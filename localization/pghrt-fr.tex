...
La prédictibilité. La prédictibilité est le truc important pour un THS. La prédictibilité, ça veut dire que ton régime est stable, et la stabilité, c'est bien. Même les pires formes d'injections (on détaillera ça plus tard) te créront un cycle hormonal plus prédictible que toutes les autres voies d'administration, ce qui a beaucoup d'avantages.
% TODO: "prédictibilité" est pas un super mot, ça manque du sens original de "niveau minimum". Stabilité peut-être ?
...
Pour faire simple, ton cerveau se fout un peu de savoir quel type d'hormone sexuelle est dans ton corps, du moment que tu en as en assez grande quantité. Si tu as tout le temps assez d'hormones dans ton corps, il ne voit pas d'intérêt à en produire plus. C'est sur cette "uniformité" que les injections résussissent là où les autres voies d'administration sont plus en peine. Faire une monothérapie avec des pilules, par exemple, est quasiment impossible dans la plupart des situations. Si tu veux que je précise un peu, si on regarde les HPG, \textit{luteinizing hormone} (LH) et \textit{follicle-stimulating hormone} (FSH) sont 
...
On va pas se mentir, les piqûres dont peur, surtout au début. Beaucoup de gens n'aiment pas ça, parce qu'instintivement tu ne veux pas faire des trous dans ton corps, mais avec une bonne technique et de bons instruments, ça fait pas mal du tout. 
% fin du traduit ici
...
% TODO Véirifier que j'ai rien cassé avec mes merges pourris sur cette section
