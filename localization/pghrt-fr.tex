...
% TODO:  La traduction de la vanne est pas top ?
...
% TODO: Doute sur le fait que les progestatifs de synthèse s'appelent les progestrogènes en Français ? J'ai rien vu qui le confirme, les articles parlent de progestatifs de synthèse directement.
...
Un ajutsement de doage de 0,1mg est une différence qui ne devrait pas être perceptible pour la simple et bonne raison que nos corps ne sont pas suffisamment sensibles pour réagir à une si faible différence, même sans compter la probabilité élevée d'imprécision en faisant une injection, ce qui rend la certitude de cette mesure 
% TODO: Okay je crois que j'ai rien compris à cette ligne, j'y reviendrai plus tard
...
Ne sois pas embarassé.e, c'est une question commune. Tu peux essayer la léchitine de tournesol et le pygeum. C'à l'air d'aussi faire une différence pour la  
% TODO: A finir
...
\subsection{Est-ce que le THS peut changer tes perceptions / sens, i.e. l'odorat ?}
% TODO: c'est e.g. et pas i.e. si je me rappelle bien ?
