...
% TODO: vérifier que les noms scientifiques (médicaments, maladies, etc.) sont correctement traduits
...
\href{https://rebellyon.info/Le-guide-d-auto-injection-sous-cutanee-du-25225}{\textit{Le FLIRT et STRIP ont créé un super guide d'auto injection}}, que tu peux lire ou imprimer, et que je recommande fortement.
...
En gros, tu as deux options : \textit{en pahramacie} ou \textit{via le DIY}. Pour en demander en pharmacie, il te faudra généralement une ordonnance, vu que dans la plupart des pays, on ne peut pas obtenir d'oestrogène sans ordonnance, et quand c'est possible, ça ne concerne pas les injections. Le \textit{DIY}, c'est toutes les autres manières d'en obtenir.
