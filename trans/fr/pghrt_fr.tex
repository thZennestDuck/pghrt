...
A noter que si tu changes d'aiguille entre le prélèvement et l'injection, il faut un peu tirer sur le piston avant d'enlever l'aiguille de prélèvement pour que le fluide bloqué dans l'aiguille ne soit pas gaché. C'est pas grand-chose, mais ça peut des fois faire une différence. \textbf{A noter aussi que les marquages sur la seringue prennent en compte le volume à injecter *en plus de* l'espace mort (i.e. l'espace mort de l'aiguille est rempli avant que la sereingue ne commence à l'être), donc tu n'as pas besoin d'ajuster le volume pour tenir en compte l'espace mort. Le volume marqué reflète correctement le dosage qui sera injecté.} Le volume exact de l'espace mort dépend de l'aiguille (i.e. une aiguille de prélévement n'aura probablement pas le même espace mort qu'une aiguille d'injection), l'important là encore étant la réfularité dans tes injections. Va voir la Question \ref{7-7} pour une autre stratégie si l'espace mort t'inquiète.
